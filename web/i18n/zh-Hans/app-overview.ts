    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: '帮助访问者了解该应用收集的数据，可参考 Agent 的<privacyPolicyLink>隐私政策</privacyPolicyLink>。',
      ...
      embedded: {
        ...
        chromePlugin: '安装 Agent Chrome 浏览器扩展',
        copied: '已复制',
        copy: '复制',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Agent-WebClient',
          step2: '部署到 Vercel 中',
