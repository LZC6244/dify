const translation = {
  ...
  blocks: {
    ...
    'question-transformation': '问题改写',
    'knowledge-filter': '知识库过滤',
    'if-else': '条件分支',
    'code': '代码执行',
  ...
  blocksAbout: {
    ...
    'knowledge-filter': '知识库过滤组件',
    'question-transformation': '调用大模型基于历史问答信息，对当前问题进行改写',
  ...
  nodes: {
    ...
    questionTransformation: {
      ...
      addClass: '添加分类',
      instruction: '指令',
      instructionTip: '你可以输入自定义提示词，帮助问题改写器更好的改写用户的问题',
      instructionPlaceholder: '在这里输入你的指令',
    },
    knowledgeFilter: {
      model: '模型',
