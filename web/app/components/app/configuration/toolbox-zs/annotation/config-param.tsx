      ...
      <Panel
        ...
        headerRight={
          <div className='flex items-center'>
            <div
              className='flex items-center rounded-md h-7 px-3 space-x-1 cursor-pointer text-[#637381] hover:text-[#5E3EFB]'
            ...
            <div
              className='ml-1 flex items-center h-7 px-3 space-x-1 leading-[18px] text-xs font-medium rounded-md cursor-pointer text-[#637381] hover:text-[#5E3EFB]'
              onClick={() => {
