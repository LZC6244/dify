...
import Panel from '../base/feature-panel-zs'
    ...
    <Panel
      ...
      title={
        <div className='flex items-center'>
          <div className=''>{t('appDebug.variableTitle')}</div>
        </div>
      }
      headerRight={!readonly ? <SelectVarType onChange={handleAddVar} /> : null}
    >
      {!hasVar && (
        <div className='pt-0 pb-0 text-[14px] leading-5 text-[#9EADB9]'>{t('appDebug.notSetVar')}</div>
      )}
      {hasVar && (
