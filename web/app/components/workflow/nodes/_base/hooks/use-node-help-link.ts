  ...
  const linkMap = useMemo(() => {
    if (language === 'zh_Hans') {
      return {
        ...
        [BlockEnum.QuestionTransformation]: 'question_transformation',
        [BlockEnum.KnowledgeFilter]: 'knowledge_filter',
    ...
    return {
      ...
      [BlockEnum.QuestionTransformation]: 'question-transformation',
      [BlockEnum.KnowledgeFilter]: 'knowledge_filter',
