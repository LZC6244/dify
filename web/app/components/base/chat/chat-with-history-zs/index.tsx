        ...
        !isMobile && (
          <div className='shrink-0 p-[28px] flex flex-row items-center'>
            <div className='text-[18px] text-[#000] font-medium mr-[22px] flex flex-row items-center '>
              {
                from
                && <Image src={BackIcon} className='w-4.5 h-4.5 mr-[8px] cursor-pointer' onClick={() => { onClickBack && onClickBack() }} alt='' />
              }
              {site?.title}
            </div>
            {
...
const ChatWithHistoryWrap: FC<ChatWithHistoryWrapProps> = ({
  ...
  return (
    <ChatWithHistoryContext.Provider value={{
      ...
      <ChatWithHistory className={className} from={from} onClickBack={onClickBack} />
