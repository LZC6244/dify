...
import RetrievalMethodInfo from '../../common/retrieval-method-info-zs'
...
import EconomicalRetrievalMethodConfig from '@/app/components/datasets/common/economical-retrieval-method-config-zs'
    ...
    <div className='flex w-full h-full'>
      <div ref={scrollRef} className='relative h-full w-full overflow-y-scroll'>
        ...
        <div className={cn(s.form, isMobile && '!px-4')}>
          ...
          <div className='max-w-[644px] grid grid-cols-2 gap-[10px]'>
            <div
              className={cn(
                s.radioItem,
                s.segmentationItem,
            ...
            >
              ...
              <div className={s.typeHeader}>
                ...
                <div className={s.tip}>使用系统默认的常规解析工具进行解析</div>
              </div>
            </div>
            ...
            >
              ...
              <div className={s.typeHeader}>
                ...
                <div className={s.tip}>使用OCR技术解析文档内容，仅支持PDF</div>
              </div>
            </div>
            ...
            >
              ...
              <div className={s.typeHeader}>
                ...
                <div className={s.tip}>按照章节拆解论文，仅支持PDF文件</div>
              </div>
            </div>
                    ...
                    <div className='w-full flex flex-col gap-1'>
                      ...
                      {rules.map(rule => (
                        <div key={rule.id} className={s.ruleItem}>
                          <input id={rule.id} type="checkbox" checked={rule.enabled} onChange={() => ruleChangeHandle(rule.id)} className="w-4 h-4 rounded border-gray-300 text-[#5E3EFB] focus:ring-[#5E3EFB]" />
          ...
          <div className='max-w-[644px]'>
            ...
            {IS_CE_EDITION && indexType === IndexingType.QUALIFIED && (
              <div className='max-w-[644px] mt-[10px] rounded-lg bg-[#F6F6F9] border border-[#EFEFEF]'>
                <div className='flex justify-between items-center px-[14px] py-[14px]'>
                  {/* <div className='flex justify-center items-center w-8 h-8 rounded-lg bg-indigo-50'>
                    <MessageChatSquare className='w-4 h-4' />
                  </div> */}
                  <div className='grow'>
                    <div className='text-[14px] leading-[14px] font-medium text-[#212B36]'>{t('datasetCreation.stepTwo.QATitle')}</div>
                    <div className='mt-[9px] inline-flex items-center text-[13px] leading-[13px] text-[#9EADB9]'>
            ...
            <div className={s.source} style={{ display: 'none' }}>
