            ...
            shouldShowDataSourceTypeList && (
              <div className='flex items-center mb-6 flex-wrap gap-y-4'>
                ...
                >
                  ...
                  <span className={cn(s.selectIcon)}></span>
          ...
          {dataSourceType === DataSourceType.FILE && (
            <>
              ...
              <StepButtons
                ...
                datasetId={datasetId}
                nextBtnText={t('datasetCreation.stepOne.button')}
                onStepChange={onStepChange}
                modalBtnText={t('datasetCreation.stepOne.emptyDatasetCreation')}
                modalShowHandle={modalShowHandle}
              />
