  ...
  return (
    ...
    >
      ...
      <div className='pt-6 flex justify-end'>
        <ButtonNormal className='mr-2 rounded-lg px-5' onClick={onClose}>{t('common.operation.cancel')}</ButtonNormal>
        <Button
          disabled={loading}
          variant="primary"
          className='px-5 py-1 text-sm font-medium leading-[20px] text-white rounded-lg'
          onClick={onConfirm}>
