...
const Documents: FC<IDocumentsProps> = ({ datasetId }) => {
  ...
  return (
    <div className='flex flex-col h-full overflow-y-auto rounded-tl-[20px] shadow-[-1px_0px_0px_0px_#DFE0E8]'>
      <div className='flex flex-col justify-center gap-1 px-[30px] pt-9'>
        <h1 className={s.title}>{t('datasetDocuments.list.title')}</h1>
        <p className={s.desc}>{t('datasetDocuments.list.desc')}</p>
      </div>
      <div className='flex flex-col px-[30px] py-4 pt-[30px] flex-1'>
          ...
          <div className='flex gap-2 justify-center items-center !h-8'>
            ...
            {embeddingAvailable && (
              <Button
                ...
                className='shrink-0 text-[14px] text-white rounded-lg leading-[14px] py-[9px] px-3'>
