...
import Res from '@/app/components/share/text-generation-zs/result'
import SavedItems from '@/app/components/app/text-generate-zs/saved-items'
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className={cn(
            ...
            'fixed  bottom-4  flex hidden space-x-2 text-gray-400 font-normal text-xs',
          )}>
